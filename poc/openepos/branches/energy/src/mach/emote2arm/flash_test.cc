// OpenEPOS EMote2ARM_Flash Mediator Test Program
...
int main() {
	...
	cout
			<< "WARNING!!!! This test will change contents of the flash memory! Information on the flash memory WILL be lost!\n";
	...
	cout
			<< "Please enter a string to be written to the flash memory (end line to finish): ";
	...
	cout
			<< "We are done by now. Try reseting and checking if the string you entered is shown at the begining of this test.\n";
