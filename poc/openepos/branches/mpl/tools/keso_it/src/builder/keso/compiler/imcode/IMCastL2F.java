...
public class IMCastL2F extends IMCast {


	/* copy constuctor */
	protected IMCastL2F() { }

	public IMCastL2F(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastL2F";}
