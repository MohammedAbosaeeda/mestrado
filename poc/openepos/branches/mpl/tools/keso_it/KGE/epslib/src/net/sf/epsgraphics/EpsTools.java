...
public class EpsTools {
     ...
     */
    public static boolean createFromDrawable(Drawable d, String fileName, int x, int y, int colorMode) {
        try {
            EpsGraphics g = new EpsGraphics("EpsTools Drawable Export", new FileOutputStream(fileName + ".eps"), 0, 0,
                    x, y, colorMode);
