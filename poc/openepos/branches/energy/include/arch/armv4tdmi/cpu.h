// OpenEPOS ARMv4TDMI CPU Mediator Declarations

#ifndef __armv4tdmi_h
#define __armv4tdmi_h

#include <cpu.h>

__BEGIN_SYS

class ARMv4TDMI: public CPU_Common {
private:
	typedef Traits<ARMv4TDMI> _Traits;
	static const unsigned int CLOCK = Traits < Machine > ::CLOCK;
	static const int BUSY_WAIT_10US_LOOP_COUNT = Traits < ARMv4TDMI
			> ::BUSY_WAIT_10US_LOOP_COUNT;
...
public:
	...
	public:
		...
		Context(Log_Addr entry, Log_Addr stack_bottom, Log_Addr exit) :
				_r0(0), _r1(0), _r2(0), _r3(0), _r4(0), _r5(0), _r6(0), _r7(0), _r8(
						0), _r9(0), _r10(0), _r11(0), _r12(0), _sp(
						stack_bottom), _lr(exit), _pc(entry), _cpsr(0x60000013) {
		} // all interrupts enabled by defaul
		...
		friend Debug & operator <<(Debug & db, const Context & c) {
			db << hex;
			db << "{r0=" << c._r0 << ",r1=" << c._r1 << ",r2=" << c._r2
					<< ",r3=" << c._r3 << ",r4=" << c._r4 << ",r5=" << c._r5
					<< ",r6=" << c._r6 << ",r7=" << c._r7 << ",r8=" << c._r8
					<< ",r9=" << c._r9 << ",r10=" << c._r10 << ",r11=" << c._r11
					<< ",r12=" << c._r12 << ",SP=" << c._sp << ",LR=" << c._lr
					<< ",PC=" << c._pc << "}";
			db << dec;
			return db;
		}
...
public:
	...
	enum {
		OFF = 0, HIBERNATE = 1, DOZE = 2, FULL = 3, STANDBY = HIBERNATE, LIGHT = DOZE
	};
	static OP_Mode power() {
		return _mode;
	}
