...
template<> struct Type2Id<FPU>      { enum { ID = FPU_ID }; };
template<> struct Type2Id<TSC>      { enum { ID = TSC_ID }; };
template<> struct Type2Id<MMU>      { enum { ID = MMU_ID }; };
template<> struct Type2Id<PMU>      { enum { ID = PMU_ID }; };
...
template<> struct Type2Id<USART>     { enum { ID = USART_ID }; };
...
template<> struct Type2Id<Radio>      { enum { ID = RADIO_ID }; };
template<> struct Type2Id<GPIO_Pin>      { enum { ID = GPIO_PIN_ID }; };
template<> struct Type2Id<ADC>      { enum { ID = ADC_ID }; };
template<> struct Type2Id<Battery>      { enum { ID = BATTERY_ID }; };
...
template<> struct Type2Id<Accelerometer> { enum { ID = ACCELEROMETER_ID }; };
...
template<> struct Type2Id<Single_Core_Alarm>    { enum { ID = SINGLE_CORE_ALARM_ID }; };
template<> struct Type2Id<SMP_Alarm>    { enum { ID = SMP_ALARM_ID }; };
...
template<> struct Type2Id<ARP<void,void> >  { enum { ID = ARP_ID }; };
...
template<> struct Id2Type<FPU_ID>   { typedef FPU TYPE; };
template<> struct Id2Type<TSC_ID>   { typedef TSC TYPE; };
template<> struct Id2Type<MMU_ID>   { typedef MMU TYPE; };
template<> struct Id2Type<PMU_ID>   { typedef PMU TYPE; };
...
template<> struct Id2Type<USART_ID>  { typedef USART TYPE; };
...
template<> struct Id2Type<RADIO_ID>   { typedef Radio TYPE; };
template<> struct Id2Type<GPIO_PIN_ID>   { typedef GPIO_Pin TYPE; };
template<> struct Id2Type<ADC_ID>   { typedef ADC TYPE; };
template<> struct Id2Type<BATTERY_ID>   { typedef Battery TYPE; };
...
template<> struct Id2Type<SINGLE_CORE_ALARM_ID> { typedef Single_Core_Alarm TYPE; };
template<> struct Id2Type<SMP_ALARM_ID> { typedef SMP_Alarm TYPE; };
...
template<> struct Id2Type<ARP_ID>   { typedef ARP<void,void> TYPE; };
