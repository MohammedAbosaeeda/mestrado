...
struct Traits
{
    ...
    static const bool instances = true;
    static const bool accounting = true;
    static const bool power = true;

    static const char voltages = 7;
    static const char _2_5V = 0;
    static const char _3_0V = 1;
    static const char _3_5V = 2;
    static const char _4_0V = 3;
    static const char _4_5V = 4;
    static const char _5_0V = 5;
    static const char _5_5V = 6;
};
...
template <> struct Traits<AVR8>: public Traits<void>
{
    ...
    static const unsigned int modes = 7;
};
...
//    static const unsigned int CLOCK = 797886000;
    //static const unsigned int CLOCK = 1.600e9; // 1.667 GHz  //797886000;
    static const unsigned int CLOCK = 2.400e9;
...
// Mediators - Machine - AVR_Common
#if defined(__atmega16) || defined(__atmega128)
...
template <> struct Traits<AVR_UART>: public Traits<void>
{
    ...
    enum Power_Modes {
    	...
    	SEND_ONLY           = 1,//Only Tx enabled
    	RECV_ONLY           = 2,//Only Rx enabled
...
{
    static const unsigned int OPERATING_VOLTAGE = Traits<AVR8>::_3_0V;
};
...
static const unsigned int APPLICATION_STACK_SIZE = 409;
    static const unsigned int APPLICATION_HEAP_SIZE = 512;    

    static const unsigned int SYSTEM_STACK_SIZE = 64;
    //static const unsigned int SYSTEM_HEAP_SIZE = 4 *  APPLICATION_STACK_SIZE;
    static const unsigned int SYSTEM_HEAP_SIZE = 6 *  APPLICATION_STACK_SIZE;
};
...
template <> struct Traits<ATMega128_Timer>: public Traits<ATMega128_Common>
{
    ...
    //static const int FREQUENCY = 72; // Hz
...
template <> struct Traits<ATMega128_UART>: public Traits<AVR_UART>, public Traits<ATMega128_Common>
{
};

template <> struct Traits<ATMega128_ADC>: public Traits<AVR_ADC>, public Traits<ATMega128_Common>
{
};
...
template <> struct Traits<CMAC>: public Traits<ATMega128_Common>
{
...
template <> struct Traits<ATMega128_NIC>: public Traits<CMAC>
{
...
template <> struct Traits<ATMega128_Temperature_Sensor>: public Traits<ATMega128_Common>
{
    typedef LIST<MTS300_Temperature> SENSORS;
};

template <> struct Traits<ATMega128_Photo_Sensor>: public Traits<ATMega128_Common>
{
    typedef LIST<MTS300_Photo> SENSORS;
};

template <> struct Traits<ATMega128_Accelerometer>: public Traits<ATMega128_Common>
{
...
template <> struct Traits<Thread>: public Traits<void>
{
    ...
    // Common Scheduler
    typedef Scheduling_Criteria::PriorityLong Criterion;
    typedef Scheduling_Scheduler::Scheduler<Thread> Scheduler;

//    // EDF Scheduler
//    typedef Scheduling_Criteria::EDF Criterion;
//    typedef Scheduling_Scheduler::Scheduler_EDF<Thread> Scheduler;

//          // Imprecise Scheduler
//    typedef Scheduling_Criteria::EDF Criterion;
//    ////typedef Scheduling_Criteria::Imprecise Criterion;
//    typedef Scheduling_Scheduler::Scheduler_Imprecise<Thread> Scheduler;
    ...
    static const unsigned int M_QUANTUM = 10;
    //static const unsigned int QUANTUM = 15000; // usS
    //static const unsigned int M_QUANTUM = 15;
};

//template <> struct Traits<Scheduler<Thread> >: public Traits<void>
template <> struct Traits<Scheduling_Scheduler::Scheduler<Thread> >: public Traits<void>
{
};

template <> struct Traits<Battery_Lifetime>: public Traits<void>
{
    static const bool enabled = true;
    static const unsigned long long lifetime = 3600 * 24 * 12;
    static const unsigned int threshold = 0x5fff; // 0xfffe
    static const unsigned int boundary = 2000;
};
...
template <> struct Traits<Active_Power_Manager>: public Traits<void>
{
    static const bool enabled = true;
    typedef Devices_Manager Devices;
    static const bool uart_enabled = true;
    static const bool adc_enabled = true;
    static const int Action_Deadline = 40000; //micro-seconds
    static const int FREQUENCY = 400000; //micro-seconds
};

template <> struct Traits<ATMega128_Battery>: public Traits<void>
{
    static const unsigned long long  MA_HR = 3000;
    static const unsigned long long  FIVE_PERCENT_UA_MS = 180000000 * MA_HR;
    /*
     * Equivalente a (MA_HR/20) * 3.600.000 * 1000, 
     * que significa 5% do valor de MA_HR, que está em mAh
     * convertido para uAms
     */
};
