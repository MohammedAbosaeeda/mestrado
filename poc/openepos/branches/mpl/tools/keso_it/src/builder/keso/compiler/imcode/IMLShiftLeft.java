...
public class IMLShiftLeft extends IMShiftLeft {


	/* copy constuctor */
	protected IMLShiftLeft() { }

	public IMLShiftLeft(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLShiftLeft nnode = new IMLShiftLeft();
