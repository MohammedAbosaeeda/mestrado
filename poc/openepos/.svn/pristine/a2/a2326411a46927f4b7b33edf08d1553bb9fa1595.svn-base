...
protected:
    ...
    static const unsigned int CHANNELS = 10;
...
public:
    ...
    static void unset_channel(int channel) { _channels[channel] = 0; }
...
// Timer used by Thread to sample hardware counters
class PMU_Sampling_Timer: public PC_Timer
{
private:
    typedef RTC::Microsecond Microsecond;
public:
    PMU_Sampling_Timer(const Microsecond & period, const Handler *handler):
    PC_Timer(1000000 / period, handler, Machine::cpu_id()) {}
};
