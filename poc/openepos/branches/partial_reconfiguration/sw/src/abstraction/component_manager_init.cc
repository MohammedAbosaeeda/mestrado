...
void Component_Manager::init()
{
    ...
    if(Traits<Implementation::MAC>::hardware){
        db<Component_Manager>(INF) << "\tMAC:\n";
        init_hw_resource(Implementation::MAC_ID, Implementation::Resource_Table<Implementation::MAC,0>::IID[0], Implementation::Resource_Table<Implementation::MAC,0>::X, Implementation::Resource_Table<Implementation::MAC,0>::Y, Implementation::Resource_Table<Implementation::MAC,0>::LOCAL);
    }
    if(Traits<Implementation::AES>::hardware){
        db<Component_Manager>(INF) << "\tAES:\n";
        init_hw_resource(Implementation::AES_ID, Implementation::Resource_Table<Implementation::AES,0>::IID[0], Implementation::Resource_Table<Implementation::AES,0>::X, Implementation::Resource_Table<Implementation::AES,0>::Y, Implementation::Resource_Table<Implementation::AES,0>::LOCAL);
    }
...
inline void Component_Manager::init_hw_resource(int type_id, unsigned int iid,
        unsigned int addr_x, unsigned int addr_y, unsigned int addr_local) {
    db<Component_Manager>(INF) << "\t\tTID=" << type_id << ",IID=" << iid <<
        ",PHY_X=" << addr_x << ",PHY_Y=" << addr_y << ",PHY_LOCAL=" <<
        addr_local << "\n" ;
