...
// Relative Scheduling Queue (non-atomic)
template <class T, typename R, typename El >
class Scheduling_Queue<T, R, false, true, El>: private Scheduling_List<T, R, El, true>
{
private:
    typedef Scheduling_List<T, R, El, true> Base;
...
template <class T, typename R, typename El>
class Scheduling_Queue<T, R, true, false, El>: private Scheduling_List<T, R, El>
{
private:
    typedef Scheduling_List<T, R, El> Base;
...
// Relative Scheduling Queue (atomic)
template <class T, typename R, typename El>
class Scheduling_Queue<T, R, true, true, El>: private Scheduling_List<T, R, El, true>
{
private:
    typedef Scheduling_List<T, R, El, true> Base;
