#ifndef __MY_TRANSCEIVER_H
#define __MY_TRANSCEIVER_H
...
class Transceiver_Controller
{
public:
    static const int FRAME_BUFFER_SIZE = My_Transceiver::MAX_PACKET_SIZE;

    typedef My_Transceiver Radio;
    typedef My_Transceiver::Event Event;
    ...
    static void set_event_handler(My_Transceiver::event_handler * handler);
