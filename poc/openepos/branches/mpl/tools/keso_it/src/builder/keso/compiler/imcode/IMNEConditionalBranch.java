...
public class IMNEConditionalBranch extends IMConditionalBranch {


	/* copy constuctor */
	protected IMNEConditionalBranch() { }

	public IMNEConditionalBranch(IMMethod method, int bc, int bcpos, IMBasicBlock label, IMBasicBlock next) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMNEConditionalBranch nnode = new IMNEConditionalBranch();
	...
	public String dumpBC() {return "NEConditionalBranch";}
