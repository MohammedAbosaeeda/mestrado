...
final public class Hashtable //extends Dictionary //implements Cloneable
{ 
	Object[] keys;
	Object[] values;
	int capacity;
	...
	public Hashtable() { this(32); }

	public Hashtable(int initialCapacity) { this(initialCapacity, 75); }
