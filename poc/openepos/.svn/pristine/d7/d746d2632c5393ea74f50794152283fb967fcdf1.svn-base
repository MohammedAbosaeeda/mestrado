...
POWER_MANAGER_DEFINITIONS(AVR8)
{
    	/*[power_mode][tension]*/
		/*{2.5V, 3.0V, 3.5V, 4.0V, 4.5V, 5.0V, 5.5V}*/
		{ 7600 , 12000 , 0, 0, 0, 0, 0 }, //FULL
		{ 3300 ,   470 , 0, 0, 0, 0, 0 }, //IDLE
		{ 1000 ,     0 , 0, 0, 0, 0, 0 }, //ADC_NOISE_REDUCTION
		{  116 ,     0 , 0, 0, 0, 0, 0 }, //POWER_DOWN
		{  124 ,     0 , 0, 0, 0, 0, 0 }, //POWER_SAVE
		{  237 ,     0 , 0, 0, 0, 0, 0 }, //NATIVE_STANDBY
		{  243 ,     0 , 0, 0, 0, 0, 0 }  //EXTENDED_STANDBY
};
