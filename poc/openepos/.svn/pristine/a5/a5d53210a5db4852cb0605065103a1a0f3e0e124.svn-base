...
public class IMCastI2L extends IMCast {


	/* copy constuctor */
	protected IMCastI2L() { }

	public IMCastI2L(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastI2L";}
