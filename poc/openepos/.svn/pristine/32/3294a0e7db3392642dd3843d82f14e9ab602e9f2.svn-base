...
public class IMCastF2I extends IMCast {


	/* copy constuctor */
	protected IMCastF2I() { }

	public IMCastF2I(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastF2I";}
