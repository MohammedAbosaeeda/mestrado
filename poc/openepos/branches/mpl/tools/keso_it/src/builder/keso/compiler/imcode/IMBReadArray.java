...
public class IMBReadArray extends IMReadArray {


	/* copy constuctor */
	protected IMBReadArray() { }

	public IMBReadArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMBReadArray nnode = new IMBReadArray();
