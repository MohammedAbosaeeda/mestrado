...
public:
	...
	IRQ_CMAC_TIMER 	 = IRQ_TIMER3_COMPA,
    };
...
public: //more stuff
    ...
    static void enable_external_int(ext_irq_number_t irqNumber, irq_mode_t irqMode){
    	// IRQ pin is input
    	CPU::out8(IO::DDRE, CPU::in8(IO::DDRE) & ~(1 << irqNumber));
    	CPU::out8(IO::PORTE, CPU::in8(IO::PORTE) | (1 << irqNumber));
    	unsigned char ui8ShiftCount = (irqNumber - EXT_IRQ_4) << 1;
