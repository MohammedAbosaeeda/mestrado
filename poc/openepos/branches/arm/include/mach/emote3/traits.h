...
class eMote3_Common;
template <> struct Traits<eMote3_Common>: public Traits<void>
{
    static const bool debugged = Traits<void>::debugged;
};

template <> struct Traits<eMote3>: public Traits<eMote3_Common>
{
    ...
    static const unsigned int SYS_DATA  = 0x20002000; // Library mode only => APP + SYS
...
template <> struct Traits<eMote3_IC>: public Traits<eMote3_Common>
{
};

template <> struct Traits<eMote3_Timer>: public Traits<eMote3_Common>
{
...
template <> struct Traits<eMote3_UART>: public Traits<eMote3_Common>
{
...
template <> struct Traits<eMote3_Scratchpad>: public Traits<eMote3_Common>
{
