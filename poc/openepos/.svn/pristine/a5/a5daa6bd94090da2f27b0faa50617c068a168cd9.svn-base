...
public class IMDStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMDStoreArray() { }

	public IMDStoreArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMDStoreArray nnode = new IMDStoreArray();
