...
public class IMFGCompare extends IMCompare {


	/* copy constuctor */
	protected IMFGCompare() { }

	public IMFGCompare(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMFGCompare nnode = new IMFGCompare();
	...
	public String dumpBC() {return "FGCompare";}
