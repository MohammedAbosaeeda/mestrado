...
public class IMCastF2D extends IMCast {


	/* copy constuctor */
	protected IMCastF2D() { }

	public IMCastF2D(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastF2D";}
