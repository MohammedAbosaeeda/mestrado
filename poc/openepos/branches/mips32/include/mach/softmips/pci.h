...
#ifndef __testmips_pci_h
#define __testmips_pci_h

#include <pci.h>

__BEGIN_SYS

class TestMIPS_PCI: public PCI_Common
{
private:
    typedef Traits<TestMIPS_PCI> _Traits;
//    static const Type_Id _TYPE = Type<TestMIPS_PCI>::TYPE;
