...
public:
    ...
    enum {
        // TIMSK
        OCIE2  = 0x80, ///< Timer/Counter2 Compare Match Interrupt Enable, in TIMSK register. See AVR manual.
        TOIE2  = 0x40,OCIE2
        TICIE1 = 0x20,
        OCIE1A = 0x10,
        OCIE1B = 0x08,
        ...
        TOIE0  = 0x01,
        // ETIMSK
        TICIE3 = 0x20, ///< Timer/Counter3, Input Capture Interrupt Enable, in ETIMSK register. See AVR manual.
        OCIE3A = 0x10,
        OCIE3B = 0x08,
        TOIE3  = 0x04,
        OCIE3C = 0x02,
