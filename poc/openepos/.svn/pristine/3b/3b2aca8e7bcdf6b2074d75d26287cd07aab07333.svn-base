...
template <> struct Traits<Heap>: public Traits<void>
{
    ...
    static const bool always_atomic = true;
};
...
template <> struct Traits<Thread*>: public Traits<Thread> {};
...
{
    static const bool enabled = Traits<Unified::Add>::hardware ||
                                Traits<Unified::Mult>::hardware;
