...
/* EPOS Abstractions and Mediators */
// PeriodicThread
#define NATIVE_CLASS_PERIODIC_THREAD         (NATIVE_CLASS_BASE+29)     /* 45 */
#define NATIVE_METHOD_INIT_PERIODIC_THREAD   0
#define NATIVE_METHOD_START                  1

// TemperatureSensor
#define NATIVE_CLASS_TEMPERATURE_SENSOR      (NATIVE_CLASS_BASE+30)     /* 46 */
#define NATIVE_METHOD_INIT_TEMPERATURE_SENSOR 0
#define NATIVE_METHOD_SAMPLE                 1 

// NIC
#define NATIVE_CLASS_NIC                     (NATIVE_CLASS_BASE+31)     /* 47 */
#define NATIVE_METHOD_INIT_NIC               0
...
#define NATIVE_CLASS_PME                     (NATIVE_CLASS_BASE+32)     /* 48 */
#define NATIVE_METHOD_INIT_PME               0
#define NATIVE_METHOD_PME_MATCH              1    

// Picture
#define NATIVE_CLASS_PICTURE                 (NATIVE_CLASS_BASE+33)     /* 49 */
#define NATIVE_METHOD_INIT_PICTURE           0

// PictureMotionCounterpart
#define NATIVE_CLASS_PMC                     (NATIVE_CLASS_BASE+34)     /* 50 */
#define NATIVE_METHOD_INIT_PMC               0

// TestSupport
#define NATIVE_CLASS_TEST_SUPPORT            (NATIVE_CLASS_BASE+35)     /* 51 */
#define NATIVE_METHOD_INIT_TEST_SUPPORT      0
#define NATIVE_METHOD_TS_CREATE_PICTURE      1
#define NATIVE_METHOD_TS_TEST_PMC            2

/* --- */

// nanovm/newmath/Adder
#define NATIVE_CLASS_ADDER                   (NATIVE_CLASS_BASE+36)     /* 52 */
