...
public class IMLEConditionalBranch extends IMConditionalBranch {


	/* copy constuctor */
	protected IMLEConditionalBranch() { }

	public IMLEConditionalBranch(IMMethod method, int bc, int bcpos, IMBasicBlock label, IMBasicBlock next) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLEConditionalBranch nnode = new IMLEConditionalBranch();
	...
	public String dumpBC() {return "LEConditionalBranch";}
