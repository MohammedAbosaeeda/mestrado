...
public:
    System::Dummy_Component_For_Proxy proxy;

    Dummy_HW_Area_Test(Channel_t &rx_ch, Channel_t &tx_ch, unsigned char iid[Traits<Dummy_HW_Area_Test>::n_ids])
        :Component(rx_ch, tx_ch, iid[0]),
         proxy(rx_ch, tx_ch, &iid[1]){}
