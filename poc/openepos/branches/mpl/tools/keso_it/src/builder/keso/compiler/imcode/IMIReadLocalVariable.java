...
public class IMIReadLocalVariable extends IMReadLocalVariable {


	/* copy constuctor */
	protected IMIReadLocalVariable() { }

	public IMIReadLocalVariable(IMMethod method, int bc, int bcpos, int var) {
		this(method,bc,bcpos,
			method.getMethodFrame().getLocalVariable(BCBasicDatatype.INT,var));
	}

	public IMIReadLocalVariable(IMMethod method, int bc, int bcpos, IMSlot var) {
		super(method,bc,BCBasicDatatype.INT,bcpos, var);
	}

	public IMIReadLocalVariable(IMMethod method, int bc, int type, int bcpos, IMSlot var) {
		super(method,bc,type,bcpos, var);
	}

	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {

		IMIReadLocalVariable nnode = new IMIReadLocalVariable();
