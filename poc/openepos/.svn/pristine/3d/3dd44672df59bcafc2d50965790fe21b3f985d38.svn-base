...
public class IMIShiftRight extends IMShiftRight {


	/* copy constuctor */
	protected IMIShiftRight() { }

	public IMIShiftRight(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMIShiftRight nnode = new IMIShiftRight();
