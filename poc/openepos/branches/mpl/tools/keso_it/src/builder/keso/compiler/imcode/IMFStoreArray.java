...
public class IMFStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMFStoreArray() { }

	public IMFStoreArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMFStoreArray nnode = new IMFStoreArray();
