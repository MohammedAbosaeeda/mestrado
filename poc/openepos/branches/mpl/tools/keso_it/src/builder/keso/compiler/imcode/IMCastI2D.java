...
public class IMCastI2D extends IMCast {


	/* copy constuctor */
	protected IMCastI2D() { }

	public IMCastI2D(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastI2D";}
