...
public class IMIStoreLocalVariable extends IMStoreLocalVariable {


	/* copy constuctor */
	protected IMIStoreLocalVariable() { }

	public IMIStoreLocalVariable(IMMethod method, int bc, int bcpos, int var) {
		this(method,bc,bcpos,
			method.getMethodFrame().getLocalVariable(BCBasicDatatype.INT,var));
	}

	public IMIStoreLocalVariable(IMMethod method, int bc, int bcpos, IMSlot var) {
		super(method,bc,BCBasicDatatype.INT,bcpos, var);
	}

	public IMIStoreLocalVariable(IMMethod method, int bc, int type, int bcpos, IMSlot var) {
		super(method,bc,type,bcpos, var);
	}

	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {

		IMIStoreLocalVariable nnode = new IMIStoreLocalVariable();
