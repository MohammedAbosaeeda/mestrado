...
public:
    ...
    struct Boot_Map
    {
        ...
        int setup_offset;                 // Setup32 offset (-1 => not present)
        int setup64_offset;               // Setup64 offset (-1 => not present)
        int init_offset;
        int system_offset;
    ...
    struct Physical_Memory_Map
    {
 	...
 	PAddr ext_top;       // Boot Image EXTRA segment top address
        ...
        PAddr sys_pdp;       // System Page Directory Pointer
        PAddr sys_pml4;      // System Page Map Lvl4
        PAddr apic_pt;
