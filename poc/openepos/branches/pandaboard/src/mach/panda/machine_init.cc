#include <mach/panda/machine.h>
#include <mach/panda/memory_map.h>
#include <mach/panda/scu.h>
...
void PandaBoard::init()
{
    ...
    System_Info<PandaBoard> * si;
    
    si = reinterpret_cast<System_Info<PandaBoard> *>(Memory_Map<PandaBoard>::SYS_INFO);
