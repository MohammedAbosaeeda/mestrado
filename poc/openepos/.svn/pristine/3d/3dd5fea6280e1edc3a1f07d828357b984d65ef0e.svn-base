...
class Secure_NIC : public Diffie_Hellman, Conditional_Observer, public Conditionally_Observed
{
	public:
	...
	char _received_data[Traits<CMAC<Radio_Wrapper> >::MTU];
