...
public class CodeGenerator {
	...
	CodeGenerator(HighlevelConfiguration conf, CommandLineOptions cmdLine) {
        ...
        if(cmdLine.getBackend().equals("JOSEK")) {
            /*
            ...
            */
        } else if(cmdLine.getBackend().equals("c_generator")) {
			codeHooks.add((new CH_EO_C_os_cc_includes().init("CH_EO_C_os_cc_includes", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_os_cc_tasks().init("CH_EO_C_os_cc_tasks", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_os_cc_resources().init("CH_EO_C_os_cc_resources", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_os_cc_alarmsData().init("CH_EO_C_os_cc_alarmsData", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_os_cc_mainFunc().init("CH_EO_C_os_cc_mainFunc", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_os_cc_prototypes().init("CH_EO_C_os_cc_prototypes", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_os_cc_alarmsFuncDefs().init("CH_EO_C_os_cc_alarmsFuncDefs", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_osek_os_h_enums().init("CH_EO_C_osek_os_h_enums", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_osek_os_h_taskDecs().init("CH_EO_C_osek_os_h_taskDecs", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_osek_os_h_hookPrototypes().init("CH_EO_C_osek_os_h_hookPrototypes", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_thread_osek_cc_preTaskHook().init("CH_EO_C_thread_osek_cc_preTaskHook", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_thread_osek_cc_postTaskHook().init("CH_EO_C_thread_osek_cc_postTaskHook", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_osek_task_cc_startupHook().init("CH_EO_C_osek_task_cc_startupHook", conf, cmdLine)));
			codeHooks.add((new CH_EO_C_osek_task_cc_shutdownHook().init("CH_EO_C_osek_task_cc_shutdownHook", conf, cmdLine)));
        } else if(cmdLine.getBackend().equals("EPOS-OSEK4C++")) {
            /*
			codeHooks.add((new CH_EO_CPP_os_cc_includes().init("CH_EO_CPP_os_cc_includes", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_os_cc_tasks().init("CH_EO_CPP_os_cc_tasks", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_os_cc_resources().init("CH_EO_CPP_os_cc_resources", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_os_cc_alarmsData().init("CH_EO_CPP_os_cc_alarmsData", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_os_cc_mainFunc().init("CH_EO_CPP_os_cc_mainFunc", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_os_cc_prototypes().init("CH_EO_CPP_os_cc_prototypes", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_os_cc_alarmsFuncDefs().init("CH_EO_CPP_os_cc_alarmsFuncDefs", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_osek_os_h_enums().init("CH_EO_CPP_osek_os_h_enums", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_osek_os_h_taskDecs().init("CH_EO_CPP_osek_os_h_taskDecs", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_osek_os_h_hookPrototypes().init("CH_EO_CPP_osek_os_h_hookPrototypes", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_thread_osek_cc_preTaskHook().init("CH_EO_CPP_thread_osek_cc_preTaskHook", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_thread_osek_cc_postTaskHook().init("CH_EO_CPP_thread_osek_cc_postTaskHook", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_osek_task_cc_startupHook().init("CH_EO_CPP_osek_task_cc_startupHook", conf, cmdLine)));
			codeHooks.add((new CH_EO_CPP_osek_task_cc_shutdownHook().init("CH_EO_CPP_osek_task_cc_shutdownHook", conf, cmdLine)));
            */
		}
	}
	...
	private void includeFile(String file, boolean archDependent, boolean parse) throws IOException, FileNotFoundException {
		...
		if (!archDependent) {
			file = cmdLine.getRuleDirectory() + "snippets/independent/" + file;
		} else {
			...
			file = cmdLine.getRuleDirectory() + "snippets/arch/" + arch + "/" + file;
		}
