...
abstract public class BCBasicDatatype {
	...
	public static final char toChar(int datatype) {
		switch (datatype) {
			...
			case UNKNOWN_TYPE: return '?'; 
			case RETURN_ADDRESS: return 'R'; 
			case SECOND_SLOT: return '~'; 
	...
	public final static int toBasicDatatype(String typeDesc) {
		return toBasicDatatype(typeDesc.charAt(0));
	}

	public final static int toBasicDatatype(char sym) {
		switch (sym) {
			case 'I': return INT;
			case 'J': return LONG;
			case 'F': return FLOAT; 
