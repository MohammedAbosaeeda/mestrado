...
{    
    typedef Scheduling_Criteria::OSEK_Priority Criterion;
...
template <> struct Traits<OSEK_Task>: public Traits<void>
{
	static const bool debugged = false;
};


template <> struct Traits<NanoVM>: public Traits<void>
{
    static const bool debugged = false;
};
...
template <> struct Traits<CMAC<Radio_Wrapper> >: public Traits<void>
{
    ...
    static const unsigned long SLEEPING_PERIOD = 0;  // ms
    static const unsigned long TIMEOUT         = 500;   // ms
    static const unsigned long BACKOFF         = 0;     // ms
    static const unsigned char ADDRESS         = 0x0001;
    static const unsigned int  MTU             = 107; 
};
