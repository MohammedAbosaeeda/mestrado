...
class Dynamic_Allocation : public System::Dynamic_Allocation<Obj_Type,false>{};

template<typename Obj_Type>
class System_Dynamic_Allocation : public System::Dynamic_Allocation<Obj_Type,true>{};
