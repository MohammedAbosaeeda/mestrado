...
public class IMLReadArray extends IMReadArray {


	/* copy constuctor */
	protected IMLReadArray() { }

	public IMLReadArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLReadArray nnode = new IMLReadArray();
