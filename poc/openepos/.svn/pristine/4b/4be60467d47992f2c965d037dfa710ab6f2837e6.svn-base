...
public class IMFRem extends IMRem {


	/* copy constuctor */
	protected IMFRem() { }

	public IMFRem(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode constant_folding() throws CompileException {
		...
		if (lOpr.isConstant() && rOpr.isConstant()) {
			...
			clOpr.setFloatValue(clOpr.getFloatValue()%crOpr.getFloatValue());
			return clOpr;
		}
	...
	public String dumpBC() {return "FRem";}
