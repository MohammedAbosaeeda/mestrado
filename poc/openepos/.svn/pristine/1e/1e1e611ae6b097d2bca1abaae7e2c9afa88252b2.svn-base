...
public class IMLStoreLocalVariable extends IMStoreLocalVariable {


	/* copy constuctor */
	protected IMLStoreLocalVariable() { }

	public IMLStoreLocalVariable(IMMethod method, int bc, int bcpos, int var) {
		this(method,bc,bcpos,
			method.getMethodFrame().getLocalVariable(BCBasicDatatype.LONG,var));
	}

	public IMLStoreLocalVariable(IMMethod method, int bc, int bcpos, IMSlot var) {
		super(method,bc,BCBasicDatatype.LONG,bcpos, var);
	}

	public IMLStoreLocalVariable(IMMethod method, int bc, int type, int bcpos, IMSlot var) {
		super(method,bc,type,bcpos, var);
	}

	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {

		IMLStoreLocalVariable nnode = new IMLStoreLocalVariable();
