...
public class IMEQConditionalBranch extends IMConditionalBranch {


	/* copy constuctor */
	protected IMEQConditionalBranch() { }

	public IMEQConditionalBranch(IMMethod method, int bc, int bcpos, IMBasicBlock label, IMBasicBlock next) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMEQConditionalBranch nnode = new IMEQConditionalBranch();
	...
	public String dumpBC() {return "EQConditionalBranch";}
