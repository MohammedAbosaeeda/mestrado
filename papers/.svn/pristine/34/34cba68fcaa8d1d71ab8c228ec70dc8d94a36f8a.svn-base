...
template <> struct Traits<ATMega128_UART>: public Traits<void>
{
    ...
    static const char Power_Management = FULL;
    static const unsigned int DEFAULT_UNIT = 0;
};
...
template <> struct Traits<ATMega1281_Transceiver>: public Traits<ATMega1281_Common>
{
	static const bool debugged = false;
...
template <> struct Traits<CMAC>: public Traits<void>
{
    ...
    typedef CMAC_States::IEEE802154_Beacon_Sync		Sync_State;
    typedef CMAC_States::IEEE802154_Pack 			Pack_State;
    typedef CMAC_States::IEEE802154_Slotted_CSMA_Contention	Contention_State;
