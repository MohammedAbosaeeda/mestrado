...
set_property HD.RECONFIGURABLE true [get_cells u_rsp/u_recfg_mod]
add_cells_to_pblock [get_pblocks pblock_1]  [get_cells -quiet [list u_rsp/u_recfg_mod]]
resize_pblock [get_pblocks pblock_1] -add {SLICE_X50Y0:SLICE_X77Y49}
resize_pblock [get_pblocks pblock_1] -add {RAMB18_X3Y0:RAMB18_X3Y19}
resize_pblock [get_pblocks pblock_1] -add {RAMB36_X3Y0:RAMB36_X3Y9}
