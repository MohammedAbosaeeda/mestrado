...
SC_MODULE(proc_io_node){
	...
	typedef rtsnoc_bus_proxy_fast<X,Y,
							LOCAL_ADDR,
							SIZE_DATA,SIZE_X,SIZE_Y,2> rtsnoc_bus_proxy_t;
	...
	/*sc_out<sc_biguint<BUS_SIZE> > noc_din;
	sc_in<sc_biguint<BUS_SIZE> > noc_dout;
	sc_out<bool> noc_wr;
	sc_out<bool> noc_rd;
	sc_in<bool> noc_wait;
	sc_in<bool> noc_nd;*/
	...
	sc_signal<unsigned long int>& get_tsc_sig(){ return m_timer.get_tsc_sig();}
