...
public:
   ...
   //APIC base MSR
   enum {
   APIC_BASE_MSR =  0x1b, //APIC base MSR register address
   //flags
   APIC_BASE_MSR_BSP = (1 << 8), //Test if the core is the BSP
   APIC_BASE_MSR_ENABLE_X2APIC = (1 << 10), //Enable x2APIC mode
   APIC_BASE_MSR_GLOBAL_ENABLE = (1 << 11)  //APIC global enable
   };
...
public:
	...
	*static_cast<volatile Reg32 *>(_base + reg) = v;
    ...
    /*static unsigned int is_bsp() {
          return rdmsr(APIC_BASE_MSR) & APIC_BASE_MSR_BSP;
    }*/
