...
template <> struct Traits<Component_Manager>: public Traits<void>
{
    ...
    static const bool enabled = Traits<Implementation::Add>::hardware ||
                                Traits<Implementation::MAC>::hardware ||
                                Traits<Implementation::AES>::hardware ||
                                Traits<Implementation::Mult>::hardware ||
                                Traits<Implementation::DTMF_Detector>::hardware ||
                                Traits<Implementation::ADPCM_Codec>::hardware ||
                                Traits<Implementation::Dummy_Callee>::hardware ||
                                Traits<Implementation::Dummy_Caller>::hardware ||
                                Traits<Implementation::RSP_ETH>::hardware ||
                                Traits<Implementation::RSP_AES>::hardware ||
                                Traits<Implementation::RSP_ADPCM>::hardware ||
                                Traits<Implementation::RSP_DTMF>::hardware ||
                                Traits<Implementation::RSP_Controller>::hardware;// ||
                                //Traits<Implementation::Scheduler<Thread> >::hardware;

    static const bool max_resources = 8;

    static const unsigned int msg_buffer_size = 8;

    static const unsigned int resource_buffer_size = 3;
};
