...
public class IMIReadArray extends IMReadArray {


	/* copy constuctor */
	protected IMIReadArray() { }

	public IMIReadArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMIReadArray nnode = new IMIReadArray();
