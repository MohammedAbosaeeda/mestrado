...
MC13224V_GPIO_Pin * Radio_Wrapper::_gpio = 0;

typedef IO_Map<Machine> IO;

void Radio_Wrapper::gpio_on() {
	_gpio->set();
}
void Radio_Wrapper::gpio_off() {
	_gpio->clear();
}
void Radio_Wrapper::init() {
    device = new(kmalloc(sizeof(MC13224V_Transceiver))) MC13224V_Transceiver();
//	_gpio = new MC13224V_GPIO_Pin(12);
	_gpio = new MC13224V_GPIO_Pin(8);
