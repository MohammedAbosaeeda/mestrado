// OpenEPOS EMote2ARM_Buck_Regulator Mediator Declarations

#ifndef __emote2arm_buck_regulator_h
#define __emote2arm_buck_regulator_h

#include <system/config.h>

__BEGIN_SYS

class EMote2ARM_Buck_Regulator {
private:
	EMote2ARM_Buck_Regulator();
