...
#include <systemc.h>
#include <iostream>
#include <platform/common/debugs.h>
...
void virtual_platform::dump_signals(){
	...
	sc_trace(fp, soc.node_caller_0.adapted.clk, "caller_clk");
	sc_trace(fp, soc.node_caller_0.din_s, "caller_din");
	sc_trace(fp, soc.node_caller_0.dout_s, "caller_dout");
	sc_trace(fp, soc.node_caller_0.wr, "caller_wr");
	sc_trace(fp, soc.node_caller_0.rd, "caller_rd");
	sc_trace(fp, soc.node_caller_0.wait, "caller_wait");
	sc_trace(fp, soc.node_caller_0.nd, "caller_nd");
	sc_trace(fp, soc.node_caller_0.adapted.rx_ch_rsc_z, "caller_rx_ch_z");
	sc_trace(fp, soc.node_caller_0.adapted.rx_ch_rsc_vz, "caller_rx_ch_vz");
	sc_trace(fp, soc.node_caller_0.adapted.rx_ch_rsc_lz, "caller_rx_ch_lz");
	sc_trace(fp, soc.node_caller_0.adapted.tx_ch_rsc_z, "caller_tx_ch_z");
	sc_trace(fp, soc.node_caller_0.adapted.tx_ch_rsc_vz, "caller_tx_ch_vz");
	sc_trace(fp, soc.node_caller_0.adapted.tx_ch_rsc_lz, "caller_tx_ch_lz");

	sc_trace(fp, soc.node_callee_0.adapted.clk, "callee_clk");
	sc_trace(fp, soc.node_callee_0.din_s, "callee_din");
	sc_trace(fp, soc.node_callee_0.dout_s, "callee_dout");
	sc_trace(fp, soc.node_callee_0.wr, "callee_wr");
	sc_trace(fp, soc.node_callee_0.rd, "callee_rd");
	sc_trace(fp, soc.node_callee_0.wait, "callee_wait");
	sc_trace(fp, soc.node_callee_0.nd, "callee_nd");
	sc_trace(fp, soc.node_callee_0.adapted.rx_ch_rsc_z, "callee_rx_ch_z");
	sc_trace(fp, soc.node_callee_0.adapted.rx_ch_rsc_vz, "callee_rx_ch_vz");
	sc_trace(fp, soc.node_callee_0.adapted.rx_ch_rsc_lz, "callee_rx_ch_lz");
	sc_trace(fp, soc.node_callee_0.adapted.tx_ch_rsc_z, "callee_tx_ch_z");
	sc_trace(fp, soc.node_callee_0.adapted.tx_ch_rsc_vz, "callee_tx_ch_vz");
	sc_trace(fp, soc.node_callee_0.adapted.tx_ch_rsc_lz, "callee_tx_ch_lz");
...
void virtual_platform::start_plat(){
	...
	if(boot_ok) {
		...
		std::cout << "System reset and ready\n";
