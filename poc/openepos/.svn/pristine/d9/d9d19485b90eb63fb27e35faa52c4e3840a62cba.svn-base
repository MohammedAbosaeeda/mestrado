...
void ASM_Controller::initialize()
{
    ...
    for (volatile unsigned int i = 0; i < 3330; i++)
        ASMV("nop");
...
{
	/*
    CPU::out32(IO::ASM_CTR0, 0x00000000);
    CPU::out32(IO::ASM_CTR1, 0x00000000);
    CPU::out32(IO::ASM_CTR2, 0x00000000);
    CPU::out32(IO::ASM_CTR3, 0x00000000);
	*/
//	if(!already_set){ already_set = true;
    CPU::out32(IO::ASM_CTR0, 0x33333333);
    CPU::out32(IO::ASM_CTR1, 0x22222222);
    CPU::out32(IO::ASM_CTR2, 0x11111111);
    CPU::out32(IO::ASM_CTR3, 0x00000000);
/*	}
	cout << CPU::in32(IO::ASM_CTR0) << "\n" 
		 << CPU::in32(IO::ASM_CTR1) << "\n"
         << CPU::in32(IO::ASM_CTR2) << "\n"
         << CPU::in32(IO::ASM_CTR3) << "\n";
		 */
}
