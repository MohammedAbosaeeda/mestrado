// OpenEPOS ARMv4TDMI_MMU Mediator Declarations

#ifndef __armv4tdmi_mmu_h
#define __armv4tdmi_mmu_h
...
class ARMv4TDMI_MMU: public MMU_Common<0, 0, 0> {
private:
...
public:
	...
	// Page Flags
	typedef MMU_Common<0, 0, 0>::Flags ARM7_Flags;
