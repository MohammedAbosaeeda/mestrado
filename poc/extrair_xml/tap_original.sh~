...
quantum_options=(10000 20000 50000 100000 200000);
scheduling_options=('RM' 'EDF');
failure=0;
success=0;
...
echo "Quantum: 10ms, 20ms, 50ms, 100ms, 200ms">> ${email_body}
echo "Stack: 512MB, 1GB">> ${email_body}
echo "Heap: 512MB, 1GB">> ${email_body}
echo "Schedulers: EDM, RM " >> ${email_body} 
echo "">> ${email_body}
...
do
   ...
   for app_stack in "${app_stack_options[@]}"
   do
	       ...
	       do
		     ...
		     for scheduler in "${scheduling_options[@]}"
	             do
	                ...
	                log_name=${application}_AppStack_${app_stack}_AppHeap_${app_heap}_SysStack_${sys_stack}_SysHeap${sys_heap}_SysQuantum_${sys_quantum}_ThreadQuantum_${thread_quantum}_Scheduler_${scheduler}.log
