...
#define	PRINT	"	local _greeting = \"Hello\"								\
					local _white = \" \"									\
...
#define	FIB		"	function generatefib (n)								\
...
#define	BITREES	"	local function BottomUpTree(item, depth)				\
						if depth > 0 then									\
							local i = item + item							\
							depth = depth - 1								\
...
#define REDUX	"	local function fannkuch(n)								\
...
//""USING LUA'S BUILT-IN SORTING ALGORITHM""""""""""""""""""""""""""""""""""/
#define	NATIVE	"	local array = {											\
312 , 674 , 544 , 325 , 648 , 640 , 441 , 44 , 934 , 553 ,					\
352 , 90 , 525 , 714 , 796 , 84 , 239 , 955 , 485 , 359 ,					\
424 , 564 , 613 , 59 , 146 , 580 , 586 , 12 , 86 , 625 ,					\
714 , 961 , 545 , 90 , 485 , 919 , 617 , 977 , 603 , 291 ,					\
