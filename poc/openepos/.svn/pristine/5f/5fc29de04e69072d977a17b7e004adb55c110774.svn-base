// OpenEPOS EMote2ARM_NIC Mediator Declarations

#ifndef __emote2arm_nic_h
#define __emote2arm_nic_h
...
class EMote2ARM_NIC: public Radio_Common
{
private:
    typedef Traits<EMote2ARM_NIC>::NICS NICS;
    static const unsigned int UNITS = NICS::Length;

public:
    EMote2ARM_NIC(unsigned int unit = 0) {
