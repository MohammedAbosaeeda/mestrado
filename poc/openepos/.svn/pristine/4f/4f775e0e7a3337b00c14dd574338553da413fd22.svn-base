// EPOS eMote3 UART Mediator Declarations

#ifndef __emote3_uart_h__
#define __emote3_uart_h__

#include <uart.h>
#include <cpu.h>
#include <mach/common/pl011.h>

__BEGIN_SYS

class eMote3_UART: private UART_Common, private PL011
{
private:
    typedef PL011 Engine;

    static const unsigned int BAUD_RATE = Traits<eMote3_UART>::DEF_BAUD_RATE;
    static const unsigned int DATA_BITS = Traits<eMote3_UART>::DEF_DATA_BITS;
    static const unsigned int PARITY = Traits<eMote3_UART>::DEF_PARITY;
    static const unsigned int STOP_BITS = Traits<eMote3_UART>::DEF_STOP_BITS;

public:
    eMote3_UART(unsigned int baud_rate = BAUD_RATE, unsigned int data_bits = DATA_BITS,
