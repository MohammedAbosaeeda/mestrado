// OpenEPOS EMote2ARM_Battery Mediator Declarations

#ifndef __emote2arm_battery_h
#define __emote2arm_battery_h
...
class EMote2ARM_Battery: public Battery_Common {
protected:
	...
	static const unsigned int frequency = Traits<EMote2ARM_Battery>::frequency;
...
public:
	...
	static EMote2ARM_Battery & sys_batt();
...
private:
	...
	EMote2ARM_Battery_ADC _adc;
	static EMote2ARM_Battery * system_battery;
};
