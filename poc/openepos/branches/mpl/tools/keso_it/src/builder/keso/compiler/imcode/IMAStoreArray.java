...
public class IMAStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMAStoreArray() { }

	public IMAStoreArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMAStoreArray nnode = new IMAStoreArray();
