...
int slave()
{
   ...
   //cout << "LOCKS slave1 = " << (void *) locks << endl;
   //cout << "LOCKS->idlock slave1 = " << (void *) locks->idlock << endl;
   //while(1);
 ...
 ***************************************************************/
   ...
   while (!endflag) {
    ...
    (global->trackstart) = (unsigned long) clock.now();
}
         }
...
/* POSSIBLE ENHANCEMENT:  Here is where one might reset the
   statistics that one is measuring about the parallel execution */
       ...
       //sem.p();
       //cout << "(" << System::Machine::cpu_id() << ") ttime = " << (unsigned long) ttime << endl;
       //sem.v();
       //perf.overflow_control();
...
/* update values of psilm array to psilm + psim[2]  */
  ...
  //sem.p();
  //cout << "CPU ID = " << System::Machine::cpu_id() << " ";
  //perf.get_contested_access();
  //cout << "END " << System::Machine::cpu_id() << endl;
  //sem.v();
  return 0;
}
