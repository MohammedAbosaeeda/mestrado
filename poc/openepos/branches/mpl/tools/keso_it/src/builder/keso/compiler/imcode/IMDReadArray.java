...
public class IMDReadArray extends IMReadArray {


	/* copy constuctor */
	protected IMDReadArray() { }

	public IMDReadArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMDReadArray nnode = new IMDReadArray();
