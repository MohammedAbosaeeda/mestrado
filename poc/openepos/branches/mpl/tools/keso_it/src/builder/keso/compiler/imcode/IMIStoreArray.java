...
public class IMIStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMIStoreArray() { }

	public IMIStoreArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMIStoreArray nnode = new IMIStoreArray();
