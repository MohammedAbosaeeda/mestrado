...
public class IMSReadArray extends IMReadArray {


	/* copy constuctor */
	protected IMSReadArray() { }

	public IMSReadArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMSReadArray nnode = new IMSReadArray();
