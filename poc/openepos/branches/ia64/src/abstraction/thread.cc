...
int Thread::join()
{
    ...
    return *reinterpret_cast<long long *>(_stack);
}
...
void Thread::exit(int status)
{
    ...
    *reinterpret_cast<long long *>(prev->_stack) = status;
...
{ 
    return _not_booting ? reinterpret_cast<unsigned long long>(Thread::self()) : Machine::cpu_id() + 1;
}
