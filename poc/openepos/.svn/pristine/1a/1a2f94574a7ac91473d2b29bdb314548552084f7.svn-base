...
public:
    ...
    {
        return _ready[Criterion::current()].contains(obj);
    }
...
template<typename T>
class Scheduler : public IF<Traits<Scheduler_Traits>::enable_verification,
                            Verified_Scheduler<T>,
                            Imp::Scheduler<T> >::Result
{};
