...
public class IMLShiftRight2 extends IMShiftRight2 {


	/* copy constuctor */
	protected IMLShiftRight2() { }

	public IMLShiftRight2(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLShiftRight2 nnode = new IMLShiftRight2();
