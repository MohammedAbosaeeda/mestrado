// OpenEPOS EMote2ARM_ASM_Controller Mediator Declarations
// TODO: needs review, refactor (Singleton)

#ifndef __emote2arm_asm_controller_h
#define __emote2arm_asm_controller_h
...
private:
	EMote2ARM_ASM_Controller() {
		initialize();
	}

public:
	static EMote2ARM_ASM_Controller *get_instance();
...
private:
	...
	static EMote2ARM_ASM_Controller *_instance;
};
