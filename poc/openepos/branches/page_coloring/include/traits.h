...
template <> struct Traits<Thread>: public Traits<void>
{
    ...
    static const unsigned int N_CLUSTERS = 4;
    static const unsigned int CPUS_PER_CLUSTER = 2;
    static const bool debugged = false;
    static const bool smp = true;
    static const bool trace_idle = false;
    static const unsigned int QUANTUM = 10000; // us
    static const bool pmu_sampling = false;
    static const unsigned int SAMPLING_PERIOD = QUANTUM; //us
...
/*template <> struct Traits<Alarm>: public Traits<void>
{
    ...
    static const bool enabled = false;
    static const bool smp_alarm = true;
};*/
