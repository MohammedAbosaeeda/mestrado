...
public class IMCStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMCStoreArray() { }

	public IMCStoreArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMCStoreArray nnode = new IMCStoreArray();
