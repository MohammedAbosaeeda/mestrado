...
plot '../dat/jm_sub_perf.dat' using ($1) with linespoints title 'ForemanQCIF',\
     '../dat/jm_sub_perf.dat' using ($2) with linespoints title 'MobileCIF',\
     '../dat/jm_sub_perf.dat' using ($3) with linespoints title 'City4CIF',\
     '../dat/jm_sub_perf.dat' using ($4) with linespoints title 'Stockholm720p'
