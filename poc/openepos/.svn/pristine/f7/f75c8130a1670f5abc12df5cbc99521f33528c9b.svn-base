// EPOS eMote3 Timer Mediator Implementation

#include <machine.h>
#include <ic.h>
#include <mach/emote3/timer.h>

__BEGIN_SYS

// Class attributes
//eMote3_Timer::Handler* eMote3_Timer::handlers[4];
eMote3_Timer * eMote3_Timer::_channels[CHANNELS];

// Class methods
void eMote3_Timer::int_handler(const Interrupt_Id & i)
{
