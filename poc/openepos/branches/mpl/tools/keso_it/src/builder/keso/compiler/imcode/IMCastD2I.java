...
public class IMCastD2I extends IMCast {


	/* copy constuctor */
	protected IMCastD2I() { }

	public IMCastD2I(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastD2I";}
