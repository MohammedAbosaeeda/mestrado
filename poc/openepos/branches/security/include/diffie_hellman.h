...
class Diffie_Hellman
{
	...
	static const unsigned char default_base_point_x[Bignum::word * Bignum::sz_digit];
	static const unsigned char default_base_point_y[Bignum::word * Bignum::sz_digit];
	...
	public:
	int get_public(unsigned char * buffer, int buffer_size);
	...
	void calculate_key(unsigned char * key, int buffer_size, const unsigned char * Yb, int Yb_size);
};
