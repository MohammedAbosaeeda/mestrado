...
public class IMInvokeVirtual extends IMInvoke {


	/* copy constuctor */
	protected IMInvokeVirtual() { }

	protected MethodRefCPEntry cpEntry;

	public IMInvokeVirtual(IMMethod method, int bc, int bcpos, MethodRefCPEntry methodRef) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMInvokeVirtual nnode = new IMInvokeVirtual();
	...
	public String dumpBC() {return "InvokeVirtual "+cpEntry.getMemberName();}
