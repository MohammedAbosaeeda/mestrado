...
void * operator new(size_t, const _SYS::Scratchpad_Allocator &);
void * operator new[](size_t, const _SYS::Scratchpad_Allocator &);
...
{
    friend void * ::operator new(size_t, const _SYS::Scratchpad_Allocator &);
    friend void * ::operator new[](size_t, const _SYS::Scratchpad_Allocator &);
...
inline void * operator new(size_t bytes, const _SYS::Scratchpad_Allocator & allocator) {
