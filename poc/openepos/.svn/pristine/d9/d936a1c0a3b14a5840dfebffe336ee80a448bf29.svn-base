...
public class IMCastD2F extends IMCast {


	/* copy constuctor */
	protected IMCastD2F() { }

	public IMCastD2F(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastD2F";}
