...
public class IMDReadLocalVariable extends IMReadLocalVariable {


	/* copy constuctor */
	protected IMDReadLocalVariable() { }

	public IMDReadLocalVariable(IMMethod method, int bc, int bcpos, int var) {
		this(method,bc,bcpos,
			method.getMethodFrame().getLocalVariable(BCBasicDatatype.DOUBLE,var));
	}

	public IMDReadLocalVariable(IMMethod method, int bc, int bcpos, IMSlot var) {
		super(method,bc,BCBasicDatatype.DOUBLE,bcpos, var);
	}

	public IMDReadLocalVariable(IMMethod method, int bc, int type, int bcpos, IMSlot var) {
		super(method,bc,type,bcpos, var);
	}

	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {

		IMDReadLocalVariable nnode = new IMDReadLocalVariable();
