...
int main()
{
    ...
    cout << "Removing the element whose value is " << i2.i << " => " 
	 << q1.remove(&i2).get()->object()->i << "\n";
    cout << "Removing the queue's head => " << q1.remove().get()->object()->i
	 << "\n";
    cout << "Removing the element whose value is " << i4.i << " => " 
	 << q1.remove(&i4).get()->object()->i << "\n";
    cout << "Removing the queue's head =>" << q1.remove().get()->object()->i
	 << "\n";
    cout << "The queue has now " << q1.size() << " elements.\n";
    ...
    cout << "Removing the element whose value is " << j2.i << " => " 
	 << q2.remove(&j2).get()->object()->i << "\n";
    cout << "Removing the queue's head => " << q2.remove().get()->object()->i
	 << "\n";
    cout << "Removing the queue's head => " << q2.remove().get()->object()->i
	 << "\n";
    cout << "Removing the queue's head => " << q2.remove().get()->object()->i
    ...
    cout << "Removing the element whose value is " << j2.i << " => " 
	 << q3.remove(&k2).get()->object()->i << "\n";
    cout << "Removing the queue's head => " << q3.remove().get()->object()->i
	 << "\n";
    cout << "Removing the queue's head => " << q3.remove().get()->object()->i
	 << "\n";
    cout << "Removing the queue's head => " << q3.remove().get()->object()->i
