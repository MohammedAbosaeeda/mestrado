...
SC_MODULE(rtsnoc_echo_fast){
    ...
    rtsnoc_router_fast_wrapper<X, Y, P0_LOCAL_ADDR, SIZE_DATA, SIZE_X, SIZE_Y> wrapper_0;
    rtsnoc_router_fast_wrapper<X, Y, P1_LOCAL_ADDR, SIZE_DATA, SIZE_X, SIZE_Y> wrapper_1;
    rtsnoc_echo<X, Y, P0_LOCAL_ADDR, P1_LOCAL_ADDR, SIZE_DATA, SIZE_X, SIZE_Y> echo;
