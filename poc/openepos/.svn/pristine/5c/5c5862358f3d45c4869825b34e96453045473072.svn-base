...
template<
	...
	unsigned int PROC_NOC_BUS_RATE
>
void rtsnoc_bus_proxy<X,Y,LOCAL_ADDR,SIZE_DATA,SIZE_X,SIZE_Y,PROC_NOC_BUS_RATE>::int_process() {
...
template<
    ...
    unsigned int PROC_NOC_BUS_RATE//How many registers are required to keep a NOC data element
>
class rtsnoc_bus_proxy_fast : public sc_module,
    public module_if {
...
public:
    ...
    SC_HAS_PROCESS(rtsnoc_bus_proxy_fast);
    rtsnoc_bus_proxy_fast(sc_module_name nm_
            , unsigned int start_address_
            , unsigned int end_address_
            )
        : sc_module(nm_)
...
template<
    ...
    unsigned int PROC_NOC_BUS_RATE
>
void rtsnoc_bus_proxy_fast<X,Y,LOCAL_ADDR,SIZE_DATA,SIZE_X,SIZE_Y,PROC_NOC_BUS_RATE>::read(unsigned int *data, unsigned int address, int size) {
...
template<
    ...
    unsigned int PROC_NOC_BUS_RATE
>
void rtsnoc_bus_proxy_fast<X,Y,LOCAL_ADDR,SIZE_DATA,SIZE_X,SIZE_Y,PROC_NOC_BUS_RATE>::write(unsigned int data, unsigned int address, int size) {
...
template<
    ...
    unsigned int PROC_NOC_BUS_RATE
>
unsigned int rtsnoc_bus_proxy_fast<X,Y,LOCAL_ADDR,SIZE_DATA,SIZE_X,SIZE_Y,PROC_NOC_BUS_RATE>::get_start_address() const{
    return start_address;
}
...
template<
    ...
    unsigned int PROC_NOC_BUS_RATE
>
unsigned int rtsnoc_bus_proxy_fast<X,Y,LOCAL_ADDR,SIZE_DATA,SIZE_X,SIZE_Y,PROC_NOC_BUS_RATE>::get_end_address() const{
    return end_address;
}
