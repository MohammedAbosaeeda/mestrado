...
public class IMGTConditionalBranch extends IMConditionalBranch {


	/* copy constuctor */
	protected IMGTConditionalBranch() { }

	public IMGTConditionalBranch(IMMethod method, int bc, int bcpos, IMBasicBlock label, IMBasicBlock next) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMGTConditionalBranch nnode = new IMGTConditionalBranch();
	...
	public String dumpBC() {return "GTConditionalBranch";}
