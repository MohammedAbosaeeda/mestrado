...
int main()
{
    ...
    cout << "****TAP - test successful" <<endl;return 0;
}
...
int func_a()
{
    ...
    cout << "****TAP - test successful" <<endl;return 'A';
}
...
int func_b()
{
    ...
    cout << "****TAP - test successful" <<endl;return 'B';
}
...
int func_c()
{
    ...
    cout << "****TAP - test successful" <<endl;return 'C';
}
