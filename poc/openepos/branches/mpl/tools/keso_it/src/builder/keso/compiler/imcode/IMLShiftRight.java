...
public class IMLShiftRight extends IMShiftRight {


	/* copy constuctor */
	protected IMLShiftRight() { }

	public IMLShiftRight(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLShiftRight nnode = new IMLShiftRight();
