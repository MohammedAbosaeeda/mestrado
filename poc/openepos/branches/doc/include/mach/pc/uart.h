/*! @file
 *  @brief EPOS PC UART Mediator Declarations
 *
 *  CVS Log for this file:
 *  \verbinclude include/mach/pc/uart_h.log
 */
#ifndef __pc_uart_h
#define __pc_uart_h
...
public:
    ...
    /// UART Registers addresses Definitions
    enum UART_REGISTERS {
	...
	LSR = 5, ///< Line Status	R/W [0=DR,1=OE,2=PE,3=FE,4=BI,5=THRE,6=TEMT,7=FIFOE]
	MSR = 6, ///< Modem Status	R/W [0=CTS,1=DSR,2=RI,3=DCD,4=LBCTS,5=LBDSR,6=LBRI,7=LBDCD]
	SCR = 7, ///< Scratch 		R/W
