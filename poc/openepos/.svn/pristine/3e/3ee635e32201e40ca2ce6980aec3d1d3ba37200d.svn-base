...
public:
    ...
    static void setTimeStamp(unsigned long time);

    static void setMicrosecondsSWClock(long m );

    static long getMicrosecondsSWClock();
...
private:
    ...
    static volatile Time_Stamp timestamp;

    static volatile Time_Stamp microseconds;
