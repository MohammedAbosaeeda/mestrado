...
private:
    ...
    static const unsigned int SIZE = Traits<EEPROM>::SIZE; ///< EEPROM Size in bytes

public:
    //EEPROM IO Register Bit Offsets
    enum {
        //EEARH
        EEAR8 = 0, ///< EEARH first bit, see <i>EEPROM Data Memory</i> in AVR manual for details
	   //EEARL
        EEAR7 = 7,
        EEAR6 = 6,
        EEAR5 = 5,
        ...
        EEAR2 = 2,
        EEAR1 = 1,
        EEAR0 = 0, ///< EEARL first bit, see <i>EEPROM Data Memory</i> in AVR manual for details
        //EECR
