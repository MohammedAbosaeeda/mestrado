...
#elif defined  (__sparc32)

#define ARCH                    sparc32
typedef SPARC32			CPU;
typedef SPARC32_MMU		MMU;
typedef SPARC32_TSC		TSC;
#define __CPU_H			__HEADER_ARCH(cpu)
#define __TSC_H			__HEADER_ARCH(tsc)
#define __MMU_H			__HEADER_ARCH(mmu)
...
#elif defined (__leon2)

#define MACH 			leon2
typedef LEON2			Machine;
typedef Dummy<0>		PCI;
typedef LEON2_IC		IC;
typedef LEON2_Timer		Timer;
typedef LEON2_RTC		RTC;
typedef Dummy<2>		EEPROM;
typedef LEON2_UART		UART;
typedef Dummy<3>		SPI;
typedef Serial_Display  	Display;
typedef LEON2_NIC		NIC;
typedef Dummy<5>		ADC;
typedef Dummy<6>		Temperature_Sensor;
typedef Dummy<7>		Light_Sensor;
#define __MACH_H		__HEADER_MACH(machine)
#define __MEMORY_MAP_H		__HEADER_MACH(memory_map)
#define __IC_H			__HEADER_MACH(ic)
#define __TIMER_H		__HEADER_MACH(timer)
