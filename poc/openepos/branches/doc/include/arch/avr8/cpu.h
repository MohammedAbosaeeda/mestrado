/*! @file
 *  @brief EPOS AVR8 CPU Mediator Declarations
 *
 *  CVS Log for this file:
 *  \verbinclude include/arch/avr8/cpu_h.log
 */
#ifndef __avr8_h
#define __avr8_h
...
private:
    enum {
        MCUCR = 0x35, ///< AVR MCU Control Register
#if defined (__atmega128)
        SE    = 0x20, ///< CPU Sleep enable
        SM0   = 0x08, ///< Defines Sleep mode, see Power Management and Sleep Modes in AVR manual
        SM1   = 0x10, ///< Defines Sleep mode, see Power Management and Sleep Modes in AVR manual
        SM2   = 0x04  ///< Defines Sleep mode, see Power Management and Sleep Modes in AVR manual
#elif defined (__atmega16)
        SE    = 0x40, ///< CPU Sleep enable
        SM0   = 0x10, ///< Defines Sleep mode, see Power Management and Sleep Modes in AVR manual
        SM1   = 0x20, ///< Defines Sleep mode, see Power Management and Sleep Modes in AVR manual
        SM2   = 0x80  ///< Defines Sleep mode, see Power Management and Sleep Modes in AVR manual
#endif
    };
public:
    enum {
    ...
    public:
        Reg8 _sreg; ///< Context Status Register, See Flags
        Reg8 _r0;
...
private:
    static char _power_state; ///< AVR MCU current power state
};
