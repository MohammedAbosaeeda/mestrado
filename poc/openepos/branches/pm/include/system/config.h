...
typedef IF<Traits<AVR8>::power, Power_Manager<AVR8>, AVR8>::Result	CPU;
...
typedef IF<Traits<ATMega128_UART>::power,
		Power_Manager<ATMega128_UART>,
		ATMega128_UART>::Result	UART;
...
typedef IF<Traits<ATMega128_NIC>::power,
		Power_Manager<ATMega128_NIC>,
		ATMega128_NIC>::Result	NIC;

typedef IF<Traits<ATMega128_ADC>::power,
		Power_Manager<ATMega128_ADC>,
		ATMega128_ADC>::Result	ADC;
...
typedef ATMega128_Battery       Battery;
#define __MACH_H		__HEADER_MACH(machine)
#define __IC_H			__HEADER_MACH(ic)
#define __TIMER_H		__HEADER_MACH(timer)
#define __RTC_H			__HEADER_MACH(rtc)
