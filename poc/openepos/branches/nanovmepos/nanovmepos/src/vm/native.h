...
// java/lang/Thread
#define NATIVE_CLASS_THREAD         (NATIVE_CLASS_BASE+29)
#define NATIVE_METHOD_INIT          0
#define NATIVE_METHOD_START         1

//java/lang/Alarm
#define NATIVE_CLASS_ALARM          (NATIVE_CLASS_BASE+30)
#define NATIVE_METHOD_INIT          0
#define NATIVE_METHOD_DELAY         1

//java/lang/Semaphore
#define NATIVE_CLASS_SEMAPHORE      (NATIVE_CLASS_BASE+31)
#define NATIVE_METHOD_INIT          0
#define NATIVE_METHOD_P             1
#define NATIVE_METHOD_V             2
