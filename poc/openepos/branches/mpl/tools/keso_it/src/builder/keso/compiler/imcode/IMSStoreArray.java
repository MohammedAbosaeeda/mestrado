...
public class IMSStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMSStoreArray() { }

	public IMSStoreArray(IMMethod method, int bc, int bcpos) {
		super(method,bc,BCBasicDatatype.SHORT,bcpos);
	}
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMSStoreArray nnode = new IMSStoreArray();
