...
public abstract class TaskService {
	 ...
	 */
	public static int activate(Task taskID) { return E_OK; }
	 ...
	 *		 Call at interrupt level (E_OS_CALLEVEL)
	 */
	public static int chain(Task taskID) { return E_OK; }
	 ...
	 */
	public static Task getTaskID() { return null; }
	 ...
	 *
	 * TODO throw Exception on invalid Task
	 */
	public static int getTaskState(Task taskID) {
			return -1;
	}
	 ...
	 * possible.
	 *
	 * FIXME throw an exception in the error case when exceptions are
	 * supported.
	 *
	 ...
	 */
	public static Task getTaskByName(String taskName) { return null; }
}
