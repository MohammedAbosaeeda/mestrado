...
public class IMLTConditionalBranch extends IMConditionalBranch {


	/* copy constuctor */
	protected IMLTConditionalBranch() { }

	public IMLTConditionalBranch(IMMethod method, int bc, int bcpos, IMBasicBlock label, IMBasicBlock next) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLTConditionalBranch nnode = new IMLTConditionalBranch();
	...
	public String dumpBC() {return "LTConditionalBranch";}
