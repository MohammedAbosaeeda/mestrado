...
public class IMInvokeInterface extends IMInvoke {


	/* copy constuctor */
	protected IMInvokeInterface() { }

	protected InterfaceMethodRefCPEntry cpEntry;

	public IMInvokeInterface(IMMethod method, int bc, int bcpos, InterfaceMethodRefCPEntry methodRef) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMInvokeInterface nnode = new IMInvokeInterface();
	...
	public String dumpBC() {return "InvokeInterface "+cpEntry.getMemberName();}
