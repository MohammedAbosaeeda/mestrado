...
public class IMLStoreArray extends IMStoreArray {


	/* copy constuctor */
	protected IMLStoreArray() { }

	public IMLStoreArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMLStoreArray nnode = new IMLStoreArray();
