...
template <> struct Traits<Alarm>: public Traits<void>
{
	...
	//Apparently QEMU doesn't support frequencies above 1000.
	//The minimum delay time will be ceiling( 10^6/(2*FREQUENCY) ).
	//Therefore, in order to be able to count a single microsecond,
	//FREQUENCY must be greater than 50000.
	static const unsigned int FREQUENCY = 1000;//Hz
};
