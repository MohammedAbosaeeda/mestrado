...
template<> struct Type2Id<Transceiver>	{ enum { ID = TRANSCEIVER_ID }; };
...
template<> struct Type2Id<Humidity_Sensor>{ enum { ID = HUMIDITY_SENSOR_ID }; };
...
template<> struct Id2Type<TRANSCEIVER_ID>	{ typedef Transceiver TYPE; };
...
template<> struct Id2Type<HUMIDITY_SENSOR_ID> { typedef Humidity_Sensor TYPE; };
