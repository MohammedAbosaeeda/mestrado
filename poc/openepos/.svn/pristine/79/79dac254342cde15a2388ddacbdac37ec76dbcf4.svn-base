...
int Diffie_Hellman::get_public(unsigned char * buffer, int buffer_size)
{
	int i, j;
...
void Diffie_Hellman::calculate_key(unsigned char * key, int buffer_size, const unsigned char * Yb, int Yb_size)
{
	ECC_Point _Y;
	int i;
