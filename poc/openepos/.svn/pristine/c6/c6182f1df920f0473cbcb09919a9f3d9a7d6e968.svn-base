...
public:
    ...
    typedef struct {
        unsigned int data[Traits<AXI4LITE_NOC>::PROC_NOC_BUS_RATE];
    } Packet;
...
private:
    ...
    static AXI4LITE_NOC *_instantance;

public:
    static AXI4LITE_NOC& get_instance(){
        if(_instantance == 0) _instantance = new(kmalloc(sizeof(AXI4LITE_NOC))) AXI4LITE_NOC();
        return *_instantance;
    }
...
//private:
//    Busy_Semaphore<Traits<AXI4LITE_NOC>::CONCURRENCY_LIMIT>   _lock_sem;
