...
extern "C"
{
    ...
    int memcmp(const void * m1, const void * m2, unsigned int n) __attribute__ ((weak));
    void * memcpy(void * d, const void * s, unsigned int n) __attribute__ ((weak));
    void * memset(void * m, int c, unsigned int n) __attribute__ ((weak));
    void * memchr(const void * m, int c, unsigned int n) __attribute__ ((weak));
    ...
    char * strncpy(char *d, const char *s, unsigned int n) __attribute__ ((weak));
    ...
    unsigned int strlen(const char * s) __attribute__ ((weak));
    ...
    char * strncpy(char *dst0, const char *src0, unsigned int count)
    {
	char *dst = dst0;
	const char *src = src0;
	long *aligned_dst;
