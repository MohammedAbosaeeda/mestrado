...
unsigned int Resource_Table_Array<MAC>::id_count = 0;
const unsigned char Resource_Table_Array<MAC>::IID[1][Traits<MAC>::n_ids] = { {Resource_Table<MAC,0>::IID[0]} };

const unsigned char Resource_Table<AES,0>::IID[Traits<AES>::n_ids] = {0};
unsigned int Resource_Table_Array<AES>::id_count = 0;
const unsigned char Resource_Table_Array<AES>::IID[1][Traits<AES>::n_ids] = { {Resource_Table<AES,0>::IID[0]} };
...
const unsigned int PHY_Table::X[14] = { Resource_Table<Add,0>::X,
                                       Resource_Table<MAC,0>::X,
                                       Resource_Table<AES,0>::X,
...
const unsigned int PHY_Table::Y[14] = { Resource_Table<Add,0>::Y,
                                       Resource_Table<MAC,0>::Y,
                                       Resource_Table<AES,0>::Y,
...
const unsigned int PHY_Table::LOCAL[14] = { Resource_Table<Add,0>::LOCAL,
                                              Resource_Table<MAC,0>::LOCAL,
                                              Resource_Table<AES,0>::LOCAL,
