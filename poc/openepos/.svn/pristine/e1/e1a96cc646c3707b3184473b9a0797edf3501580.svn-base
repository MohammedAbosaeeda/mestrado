// OpenEPOS EMote2ARM Memory Map

#ifndef __emote2arm_memory_map_h
#define __emote2arm_memory_map_h
...
template <> struct IO_Map<EMote2ARM>
{
    enum {
