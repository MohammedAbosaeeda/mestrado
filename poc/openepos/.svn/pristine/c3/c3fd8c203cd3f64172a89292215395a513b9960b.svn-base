// OpenEPOS EMote2ARM_I2C Test Program
...
int main() {
    ...
    cout << "I2C Test App for EMote2ARM." << endl;
    ...
    i2c->set_timeout(40000); // IT23200 only supports Fast-I2C, EMote2ARM does not support it - it is unstable
