...
public class IMFReadLocalVariable extends IMReadLocalVariable {


	/* copy constuctor */
	protected IMFReadLocalVariable() { }

	public IMFReadLocalVariable(IMMethod method, int bc, int bcpos, int var) {
		this(method,bc,bcpos,
			method.getMethodFrame().getLocalVariable(BCBasicDatatype.FLOAT,var));
	}

	public IMFReadLocalVariable(IMMethod method, int bc, int bcpos, IMSlot var) {
		super(method,bc,BCBasicDatatype.FLOAT,bcpos, var);
	}

	public IMFReadLocalVariable(IMMethod method, int bc, int type, int bcpos, IMSlot var) {
		super(method,bc,type,bcpos, var);
	}

	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {

		IMFReadLocalVariable nnode = new IMFReadLocalVariable();
