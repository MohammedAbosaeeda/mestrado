...
public class IMDLCompare extends IMCompare {


	/* copy constuctor */
	protected IMDLCompare() { }

	public IMDLCompare(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMDLCompare nnode = new IMDLCompare();
	...
	public String dumpBC() {return "DLCompare";}
