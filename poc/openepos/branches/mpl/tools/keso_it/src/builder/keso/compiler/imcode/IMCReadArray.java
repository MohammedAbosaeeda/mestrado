...
public class IMCReadArray extends IMReadArray {


	/* copy constuctor */
	protected IMCReadArray() { }

	public IMCReadArray(IMMethod method, int bc, int bcpos) {
	...
	final public IMNode copy(IMCopyVisitor visitor) throws CompileException {
		...
		IMCReadArray nnode = new IMCReadArray();
