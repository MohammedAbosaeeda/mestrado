...
public class IMCastL2I extends IMCast {


	/* copy constuctor */
	protected IMCastL2I() { }

	public IMCastL2I(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastL2I";}
