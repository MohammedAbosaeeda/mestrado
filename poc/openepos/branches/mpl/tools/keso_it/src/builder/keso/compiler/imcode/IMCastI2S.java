...
public class IMCastI2S extends IMCast {


	/* copy constuctor */
	protected IMCastI2S() { }

	public IMCastI2S(IMMethod method, int bc, int bcpos) {
	...
	public String dumpBC() {return "CastI2S";}
